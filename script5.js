document.addEventListener("DOMContentLoaded", () => {
    ...
    function initializeSVG() {
        ...
        treeLayout = d3.tree().nodeSize([200, 550]);
        i = 0;
    }
...
nodeContainer.each(function (d) {
    ...
    const coords = `(${Math.round(d.x)}, ${Math.round(d.y)})`;
    ...
    // Append background rect behind text
group.insert("rect", "text.coordinates-text")
        .attr("x", bbox.x - 4)
        .attr("y", bbox.y - 2)
